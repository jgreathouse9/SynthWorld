...
The remainder of the paper proceeds as follows. The next section situates our contribution within the existing literature on causal inference in policy evaluation. We then review the synthetic historical control method (SHC) before introducing the augmented SHC (ASHC). The following section presents our theoretical results, including finite-sample error bounds and asymptotic properties. We then turn to an empirical application, replicating the analysis of Barcelona’s 2016 hotel moratorium from \citet{Bel2021}, a setting that allows us to compare ITS, SCM, SHC, and ASHC on equal footing. The paper concludes with implications for both methodological research and policy analysis.

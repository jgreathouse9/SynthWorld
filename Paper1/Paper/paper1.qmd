...
the \emph{Synthetic Historical Control} (SHC) method, following the framework proposed by @SHC This method does not rely on geographical controls, instead relying only on the treated unit's history. \par

...
format:
  pdf:
    documentclass: ectj
    include-in-header: preamble.tex   # your LaTeX preamble that loads natbib & sets \bibliographystyle{chicago}
